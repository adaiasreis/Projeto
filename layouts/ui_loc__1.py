...
class CadReserva():
    def __init__(self, janelaLocacao):

        self.janelaLocacao = janelaLocacao
    ...
    def carregaDadosCliente(self):
        ...
        for c in self.lista_clientes:
            lista_combo.append(c.nome)
        self.janelaLocacao.comboClienteR.addItems(lista_combo)
    ...
    def carregaDadosVeiculo(self):
        ...
        self.janelaLocacao.comboMarcaR.addItems(lista_combo)

    def setEventos(self):
        self.janelaLocacao.comboClienteR.currentIndexChanged.connect(self.index_changed_cliente)
        self.janelaLocacao.comboMarcaR.currentIndexChanged.connect(self.index_changed_veiculo)
        self.janelaLocacao.b_reserva.clicked.connect(self.addReserva)
        self.janelaLocacao.b_limpar.clicked.connect(self.limparCampos)

    def index_changed_cliente(self, i):
        self.clienteAtual = self.lista_clientes[i]
        self.janelaLocacao.campId_cli.setText(str(self.clienteAtual.id))
        #self.camoPlano.setText(self.clienteAtual.plano)
        print(i)

    def index_changed_veiculo(self, i):
        self.veiculoAtual = self.lista_veiculos[i]
        self.janelaLocacao.campId_vei.setText(str(self.veiculoAtual.id))
        self.janelaLocacao.campModeloR.setText(self.veiculoAtual.modelo)
        print(i)
